...
public class JhpiegoRegisterProvider extends FamilyRegisterProvider {
    private static final String TAG = JhpiegoRegisterProvider.class.getCanonicalName();
    private Context context;

    public JhpiegoRegisterProvider(Context context, CommonRepository commonRepository, Set visibleColumns, View.OnClickListener onClickListener, View.OnClickListener paginationClickListener) {
