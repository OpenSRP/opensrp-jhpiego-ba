...
import org.smartgresiter.jhpiego.listener.ImmunizationStateChangeListener;
...
import static org.smartgresiter.jhpiego.util.Constants.IMMUNIZATION_CONSTANT.VACCINE;
...
public class VaccinationAsyncTask extends AsyncTask {
    ...
    protected Object doInBackground(Object[] objects) {
        alerts = JhpiegoApplication.getInstance().getContext().alertService().findByEntityIdAndAlertNames(entityId, VaccinateActionUtils.allAlertNames("child"));
        vaccines = JhpiegoApplication.getInstance().vaccineRepository().findByEntityId(entityId);
