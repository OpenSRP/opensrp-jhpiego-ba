...
import org.smartgresiter.jhpiego.model.FamilyRegisterFramentModel;
import org.smartgresiter.jhpiego.presenter.FamilyRegisterFragmentPresenter;
import org.smartgresiter.jhpiego.provider.JhpiegoRegisterProvider;
...
public class FamilyRegisterFragment extends BaseFamilyRegisterFragment {
    ...
    public void initializeAdapter(Set<org.smartregister.configurableviews.model.View> visibleColumns) {
        JhpiegoRegisterProvider jhpiegoRegisterProvider = new JhpiegoRegisterProvider(getActivity(), commonRepository(), visibleColumns, registerActionHandler, paginationViewHandler);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, jhpiegoRegisterProvider, context().commonrepository(this.tablename));
