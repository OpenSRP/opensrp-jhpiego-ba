...
import org.smartgresiter.jhpiego.task.FamilyMemberVaccinationAsyncTask;
import org.smartgresiter.jhpiego.util.ChildDBConstants;
import org.smartgresiter.jhpiego.util.ChildHomeVisit;
...
public class ChildProfileInteractor implements ChildProfileContract.Interactor {
    ...
    public void refreshChildVisitBar(String baseEntityId, final ChildProfileContract.InteractorCallBack callback) {
        ChildHomeVisit childHomeVisit = ChildUtils.getLastHomeVisit(org.smartgresiter.jhpiego.util.Constants.TABLE_NAME.CHILD, baseEntityId);
