package org.smartgresiter.jhpiego.repository;
 ...
 */
public class JhpiegoRepository extends Repository {

    private static final String TAG = JhpiegoRepository.class.getCanonicalName();
    protected SQLiteDatabase readableDatabase;
    protected SQLiteDatabase writableDatabase;
    private Context context;
    private String password = "Jhpiego_PASS";

    public JhpiegoRepository(Context context, org.smartregister.Context openSRPContext) {
        super(context, AllConstants.DATABASE_NAME, BuildConfig.DATABASE_VERSION, openSRPContext.session(), JhpiegoApplication.createCommonFtsObject(), openSRPContext.sharedRepositoriesArray());
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.w(JhpiegoRepository.class.getName(),
